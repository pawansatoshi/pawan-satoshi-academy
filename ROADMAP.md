...
- Event management and recurring meeting scheduler

## Phase 2 — Security & Community Core
- Anti-raid, anti-spam, anti-phishing, anti-scam
- NSFW protection and audit logging
- XP/levels/leaderboards
- Suggestions and polls

## Phase 3 — Academy Engine
- Question schema/validator/loader/randomizer
- Practice quizzes
...
- Quiz explanations
- Optional external model providers must never be mandatory

## Phase 7 — Engagement & Launch Hardening
- Free activities/games where Discord supports them
- Badges, streaks and Hall of Fame
- Full security audit
- Dependency audit
- Permission audit
- Mobile UX audit
